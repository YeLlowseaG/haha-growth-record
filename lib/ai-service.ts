...
分割标准（按优先级）：
1. 必要句号分割：只在必要的句号处分割，判断标准：
   - 对话轮次转换（如从"哈哈说"转到"妈妈说"）
   - 动作与对话转换（如从动作描述转到对话）
   - 明显的话题转换（如从询问转到回答）
   - 时间间隔（如"然后"、"接着"等）
2. 时间转换：看到"然后"、"接着"、"后来"、"过了一会儿"、"第二天"、"晚上"、"早上"、"洗澡时"、"吃饭时"等
3. 场景转换：从"洗澡时"到"吃饭时"，从"家里"到"外面"，从"客厅"到"卧室"等
4. 主题转换：从"吃饭"话题转到"游戏"话题，从"学习"转到"玩耍"，从"玩具"转到"故事"等
5. 对话对象变化：从"妈妈"换成"爸爸"，从"家人"换成"朋友"，从"哈哈"换成"其他孩子"等
6. 话题转换：当对话明显转向新的话题时（如从"今天开心吗"转到"和谁一起玩"）
7. 动作与对话转换：从描述动作转向对话，或从对话转向动作描述

特别注意：
- 不是每个句号都要分割，只在必要的句号处分割
- 连续的问答可以保持在一起（如"妈:你今天开心吗?哈:今天很开心,玩得很快乐。"）
- 动作描述和对话应该分开（如"哈哈压肩膀。我拒绝他。他否认。"）
- 如果对话很短（少于3轮），通常不需要分割
...
分割标准（按优先级）：
1. 句号分割：在句号处进行分割，每个句子作为一个独立的对话片段
2. 时间转换：看到"然后"、"接着"、"后来"、"过了一会儿"、"第二天"、"晚上"、"早上"、"洗澡时"、"吃饭时"等
3. 场景转换：从"洗澡时"到"吃饭时"，从"家里"到"外面"，从"客厅"到"卧室"等
4. 主题转换：从"吃饭"话题转到"游戏"话题，从"学习"转到"玩耍"，从"玩具"转到"故事"等
5. 对话对象变化：从"妈妈"换成"爸爸"，从"家人"换成"朋友"，从"哈哈"换成"其他孩子"等
...
[
  ...
  {
    "content": "哈:妈妈是我的好朋友,爸爸是我的好朋友。",
    "date": "2024-01-01",
    "tags": ["家人", "情感", "社交"],
    "context": "哈哈回答好朋友"
  },
  {
    "content": "妈:拉拉和雯雯是不是你的好朋友?",
    "date": "2024-01-01",
    "tags": ["家人", "社交"],
    "context": "妈妈询问特定朋友"
  },
  {
    "content": "哈:不是,雯雯是别人家的女儿。",
    "date": "2024-01-01",
    "tags": ["家人", "社交"],
    "context": "哈哈否认朋友关系"
  },
  {
    "content": "妈:哦,对,雯雯是别人家的女儿,那拉拉呢?",
    "date": "2024-01-01",
    "tags": ["家人", "社交"],
    "context": "妈妈询问拉拉"
  },
  ...
  {
    "content": "妈:拉拉也是别人家的女儿,那别人家的女儿是你的好朋友吗?",
    "date": "2024-01-01",
    "tags": ["家人", "社交"],
    "context": "妈妈询问朋友定义"
  },
  {
    "content": "哈:不是,还不是,过段时间就是了,3月31号就是了。",
    "date": "2024-01-01",
    "tags": ["家人", "社交"],
    "context": "哈哈回答朋友关系"
  },
